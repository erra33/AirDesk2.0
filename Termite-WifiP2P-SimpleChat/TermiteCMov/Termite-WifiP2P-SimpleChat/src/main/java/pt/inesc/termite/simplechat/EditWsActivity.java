...
public class EditWsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       checkBoxPublic = (CheckBox) findViewById(R.id.checkBoxPublic);
        checkBoxPublic.setChecked(ws.publicWs == 1);
        ...
        final EditText editTextKeywords = (EditText) findViewById(R.id.editTextKeyWords);
        KeywordsRepo keyRepo = new KeywordsRepo(this);
        editTextKeywords.setText(keyRepo.getKeywordsById(_Ws_Id));
...
//        }
    ...
    public void saveWs(View view) {
        ...
        ws.publicWs = checkBoxPublic.isChecked() ? 1 : 0;
        ...
        if (sizeLimit <= bytesAvailable) {
            ...
            //if (inviteList.size() > 0) {
            InviteRepo repoInvite = new InviteRepo(this);
            for(String addString: addedList){
                ArrayList<String> al = new ArrayList<>();
                al.add(addString);
                repoInvite.insert(al,_Ws_Id,"",1);
            }
                //repoInvite.insert(inviteList, _Ws_Id,"",1);
            for(String deleteemail: deleteList){
                repoInvite.deletByEmailAndWsID(deleteemail,_Ws_Id);
            }
...
//        ws.publicWs = publicWs;
    ...
    public void setInviteList() {
            ...
            adapter = new InviteListAdapter(showList, this);
